...
from dinozaur.models.layers.multipliers import TensorMultiplier
...
class GINOd(torch.nn.Module):
    """GINO decoder architecture."""
        ...
        *,
        ...
        Args:
            ...
            include_gradient_features: Whether to include the spatial gradient features.
                Defaults to False.
            factorization: Factorization mode for the transformation matrices in Fourier domain.
                By default, no factorization applied. Defaults to "dense".
