"""DINOZAUR decoder model definition."""
...
class DINOZAURd(torch.nn.Module):
    """DINOZAUR decoder architecture."""
                ...
                DoubleSkipBlock(
                    ...
                    fourier_convolution=FourierConvolution(
                        ...
                        multiplier=DiffusionMultiplier(
                            in_channels=width, out_channels=width, modes=modes
                        ),
                    ),
                    mlp=MLP(
